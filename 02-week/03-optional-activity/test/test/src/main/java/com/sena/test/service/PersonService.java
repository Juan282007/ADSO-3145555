package com.sena.test.service; // Paquete donde se encuentra la lógica de negocio (capa Service)
...
import com.sena.test.Repository.PersonRepository; // Repositorio para acceder a la base de datos
import com.sena.test.dto.PersonDTO; // DTO para transferir datos sin exponer la entidad
import com.sena.test.entity.Person; // Entidad que representa la tabla en la base de datos

@Service // Marca esta clase como componente de lógica de negocio
public class PersonService {

    @Autowired // Inyecta automáticamente el repositorio
    private PersonRepository personRepository; // Permite hacer operaciones CRUD en la tabla Person
