package com.sena.test.controller; // Paquete donde están los controladores (capa que recibe las peticiones HTTP)
...
import com.sena.test.dto.PersonDTO; // DTO que se usa para enviar y recibir datos
import com.sena.test.service.PersonService; // Servicio que contiene la lógica de negocio
